...
sudo DEBIAN_FRONTEND=noninteractive apt-get install -y curl vim build-essential libtool checkinstall  python-pip python-dev gcc make sqlite3 libcurl4-openssl-dev ruby-dev libssl-dev openssl libreadline-dev
...
echo 'POSTGRESQL_DATABASE=metadataregistry_development' >> /home/vagrant/metadataregistry/.env.development
echo 'POSTGRESQL_DATABASE=metadataregistry_test' >> /home/vagrant/metadataregistry/.env.test
